...
public static void castVote(int[] Can1, int[] Can2, int[] Can3){
  ...
  public static void resetVotes(int[] Can1, int[] Can2, int[] Can3){
    Can1[0] = 0;
    Can2[0] = 0;
    Can3[0] = 0;
    System.out.println("Votes have been reset");
  }
  public static void displayResults(int[] Can1, int[] Can2, int[] Can3){
    System.out.println(" Votes for candidate 1: " + Can1[0]);
